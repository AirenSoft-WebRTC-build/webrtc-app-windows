...
namespace webrtc {
	...
	private:
		...
		bool EncodeFrame(int index, const VideoFrame& input_frame, std::vector<uint8_t>& frame_packet, uint64_t& frame_packet_pts, uint64_t& frame_packet_dts, int64_t& encode_finish_time);
